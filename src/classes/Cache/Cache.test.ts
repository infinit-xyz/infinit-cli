...
describe('Cache', () => {
  ...
  describe('Action Callback Cache', () => {
    ...
    test('txConfirmed', () => {
      ...
      actionCb01Callback('txConfirmed', { txHash: txHash01, status: 'CONFIRMED', walletAddress: '0x' })
    ...
    test('txChecked, CONFIRMED & PENDING', () => {
      ...
      vi.setSystemTime(updatedAt)
      actionCb01Callback('txChecked', { txHash: txHash02, status: 'CONFIRMED', walletAddress: '0x' })
      actionCb01Callback('txChecked', { txHash: txHash03, status: 'PENDING', walletAddress: '0x' })
    ...
    test('txChecked, REVERTED', () => {
      actionCb01Callback('txChecked', { txHash: txHash02, status: 'REVERTED', walletAddress: '0x' })
    ...
    test('txChecked, NOT_FOUND', () => {
      actionCb01Callback('txChecked', { txHash: txHash03, status: 'NOT_FOUND', walletAddress: '0x' })
